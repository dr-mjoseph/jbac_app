...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_swiper__ = __webpack_require__(460);
...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, alertCtrl, formBuilder, toastCtrl, service, modalCtrl) {
        var _this = this;
        ...
        this.service.getcount().subscribe(function (res) {
    ...
    HomePage.prototype.gotopage = function (id) {
        if (id == 1) {
    ...
    HomePage.prototype.openFormAlert = function () {
        var modal = this.modalCtrl.create('EntryFormPage');
        modal.present();
    };
    HomePage.prototype.gotoprivacy = function () {
        this.navCtrl.push('PagesPrivacyPage');
    };
    HomePage.prototype.gotonewsciew = function () {
        this.navCtrl.push('NewsViewPage');
    };
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Users\rajes\StudioProjects\jbac_app\src\pages\home\home.html"*/'<ion-header>\n\n  <!-- <ion-navbar> -->\n\n  <ion-row>\n\n    <ion-col col-2>\n\n      <p style="text-align: center;" menuToggle>\n\n        <ion-icon style="color:white;font-size: 30px;" name="menu"></ion-icon>\n\n      </p>\n\n    </ion-col>\n\n    <ion-col col-8 style="font-weight: bolder;text-align: center;font-weight: 1000;color:white">\n\n      <h2>JBAC-AP</h2>\n\n    </ion-col>\n\n\n\n    <ion-col col-2 style="text-align: center;" (click)="logout()" *ngIf="maintrue">\n\n      <br>\n\n      <ion-icon style="color:white;font-size: 30px;" name="log-out"></ion-icon>\n\n    </ion-col>\n\n\n\n    <ion-col col-2 style="text-align: center;" (click)="login()" *ngIf="!maintrue">\n\n      <br>\n\n      <ion-icon style="color:white;font-size: 30px;" name="person"></ion-icon>\n\n    </ion-col>\n\n  </ion-row>\n\n  <!-- </ion-navbar> -->\n\n</ion-header>\n\n\n\n<ion-content class="pagecss">\n\n  <div style="padding: 1%;">\n\n    <div class="swiper-container">\n\n      <div class="swiper-wrapper">\n\n        <div class="swiper-slide" *ngFor="let i of banners">\n\n          <img src="{{i.banner}}" style="width:100%;border-radius:10px;height: 195px;">\n\n        </div>\n\n      </div>\n\n      <div class="swiper-pagination"></div>\n\n    </div>\n\n  </div>\n\n\n\n  <div class="marquee">\n\n    <h3>\n\n      <span style="color:red;font-weight:bolder;font-family: \'Ramabhadra\', sans-serif;"> News </span>\n\n      : <span (click)="gotopage(12)">చర్చి పర్మిషన్ గవర్నమెంట్ ఆర్డర్స్ .</span>\n\n      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n\n      <span (click)="gotopage(14)">మీ చర్చికి మా టెక్నికల్ సొల్లుషన్స్ .</span>\n\n\n\n    </h3>\n\n  </div>\n\n\n\n  <ion-row style="text-align: center;">\n\n    <ion-col col-3 class="made" (click)="gotopage(1)">\n\n      <img style="padding:3%;width:100%" src="assets/icon/svg/information.svg">\n\n      <b>నా గురించి</b>\n\n    </ion-col>\n\n\n\n    <ion-col col-3 class="made" (click)="gotopage(3)">\n\n      <img style="padding:3%;width:100%" src="assets/icon/svg/register.svg">\n\n      <b> రిజిస్ట్రేషన్ </b>\n\n    </ion-col>\n\n\n\n    <ion-col col-3 class="made" (click)="gotopage(10)">\n\n      <img style="padding:3%;width:100%" src="assets/icon/svg/helping-hand.svg">\n\n      <b>మా సహాయం </b>\n\n    </ion-col>\n\n\n\n\n\n    <ion-col col-3 class="made" (click)="gotopage(2)">\n\n      <img style="padding:3%;width:100%" src=\'assets/icon/meetview.png\'>\n\n      <b>జరగబోయే మీటింగ్స్ </b>\n\n    </ion-col>\n\n\n\n    <ion-col col-3 class="made" (click)="gotopage(8)">\n\n      <img style="padding:3%;width:100%" src="assets/icon/meetsub.png">\n\n      <b>సబ్మిట్ మీటింగ్ పోస్టర్</b>\n\n    </ion-col>\n\n\n\n    <ion-col col-3 class="made" (click)="gotopage(14)">\n\n      <img style="padding:3%;width:100%" src="assets/icon/svg/employee.svg">\n\n      <b>టెక్నికల్<br> సోలుషన్స్ </b>\n\n    </ion-col>\n\n\n\n    <ion-col col-3 class="made" (click)="gotopage(17)">\n\n      <img style="padding:3%;width:100%" src="assets/icon/svg/news.svg">\n\n      <b> వార్తలు చుడానికి </b>\n\n    </ion-col>\n\n\n\n    <ion-col col-3 class="made" (click)="gotopage(7)">\n\n      <img style="padding:3%;width:100%" src="assets/icon/svg/tv.svg">\n\n      <b> వార్తలు నమోదు </b>\n\n    </ion-col>\n\n\n\n    <ion-col col-3 class="made" (click)="gotopage(15)">\n\n      <img style="padding:3%;width:100%" src="assets/icon/svg/picture.svg">\n\n      <b>ఫోటో గ్యాలరీ </b>\n\n    </ion-col>\n\n\n\n\n\n    <ion-col col-3 class="made" (click)="gotopage(11)">\n\n      <img style="padding:3%;width:100%" src="assets/icon/svg/contact-us.svg">\n\n      <b> మమ్మల్ని<br>సంప్రదించండి </b>\n\n    </ion-col>\n\n\n\n    <ion-col col-3 class="made" (click)="gotopage(9)">\n\n      <img style="padding:3%;width:100%" src=" assets/icon/download.png">\n\n      <b> చర్చి<br>సమయాలు </b>\n\n    </ion-col>\n\n\n\n    <ion-col col-3 class="made" (click)="gotopage(12)">\n\n      <img style="padding:3%;width:100%" src=" assets/icon/svg/permission.svg">\n\n      <b>చర్చి<br>పర్మిషన్</b>\n\n    </ion-col>\n\n    <ion-col col-3 class="made" (click)="gotopage(4)">\n\n      <img style="padding:3%;width:100%" src="assets/icon/svg/services.svg">\n\n      <b> ఇతర సర్వీసెస్ చుడానికి </b>\n\n    </ion-col>\n\n\n\n    <ion-col col-3 class="made" (click)="gotopage(5)">\n\n      <img style="padding:3%;width:100%" src="assets/icon/svg/myaccount.svg">\n\n      <b> ఇతర సర్వీసెస్ రిజిస్టర్</b>\n\n    </ion-col>\n\n\n\n    <ion-col col-3 class="made" (click)="gotopage(16)">\n\n      <img style="padding:3%;width:100%" src="assets/icon/svg/video.svg">\n\n      <b>వీడియో<br>గ్యాలరీ </b>\n\n    </ion-col>\n\n\n\n    <ion-col col-3 class="made" (click)="gotopage(6)">\n\n      <img style="padding:3%;width:100%" src="assets/icon/svg/project-manager.svg">\n\n      <b> లీడర్స్ </b>\n\n    </ion-col>\n\n\n\n    <ion-col col-3 class="made" (click)="gotopage(18)">\n\n      <img style="padding:3%;width:100%" src="assets/icon/svg/123.svg">\n\n      <b> దాడుల నమోదు </b>\n\n    </ion-col><br> \n\n    <!-- <ion-col col-3 class="made" (click)="gotopage(13)">\n\n      <img style="padding:3%;width:100%" src="assets/icon/svg/cloud-computing.svg">\n\n      <b>వెబ్-సైట్ </b>\n\n    </ion-col> -->\n\n\n\n    <ion-col col-3 *ngIf="maintrue" class="made" (click)="logout()">\n\n      <img style="padding:3%;width:100%" src="assets/icon/svg/exit.svg">\n\n      <b> లాగ్ అవుట్ </b>\n\n    </ion-col>\n\n  </ion-row>\n\n  \n\n <br>\n\n  <ion-row>\n\n    <ion-col col-2></ion-col>\n\n    <ion-col col-8 style="background-color: white;text-align: center;border-radius: 10px;">\n\n      Application Visitors Count : <b>{{count}}</b>\n\n    </ion-col>\n\n    <ion-col col-2></ion-col>\n\n  </ion-row>\n\n  <br>\n\n  <ion-row>\n\n    <ion-col col-2></ion-col>\n\n    <ion-col col-8 style="background-color: white;text-align: center;border-radius: 10px;">\n\n      <b> <a (click)="gotoprivacy()">Privacy Policy</a></b>\n\n    </ion-col>\n\n    <ion-col col-2></ion-col>\n\n  </ion-row>\n\n  <br><br>\n\n</ion-content>\n\n\n\n<ion-footer\n\n  style="background-color: white; border-radius: 15px 15px 0px 0px;font-family: \'Ramabhadra\', sans-serif!important;">\n\n  <ion-row style="text-align: center;color:#1f376e">\n\n    <ion-col col-3>\n\n      <ion-icon style="font-size:34px;color:#1f376e" name="home"></ion-icon>\n\n      <br><b>హోమ్</b>\n\n    </ion-col>\n\n    <ion-col col-6>\n\n      <img style="margin-top:-18%;width:36%;" src="assets/icon/footer_logo.png">\n\n      <p style="font-size: 9px; font-weight: 1000; color: red;">\n\n        జీసస్ బిలీవర్స్ అసోసియేషన్, ఆంధ్ర ప్రదేశ్\n\n      </p>\n\n    </ion-col>\n\n    <ion-col col-3 (click)="gotoprofile()">\n\n      <ion-icon style="font-size:34px;color:#1f376e" name="person"></ion-icon>\n\n      <br>\n\n      <b *ngIf="maintrue">ప్రొఫైల్</b>\n\n      <b *ngIf="!maintrue">లాగిన్</b>\n\n    </ion-col>\n\n  </ion-row>\n\n</ion-footer>'/*ion-inline-end:"C:\Users\rajes\StudioProjects\jbac_app\src\pages\home\home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["r" /* NavController */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1__angular_forms__["a" /* FormBuilder */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["v" /* ToastController */], __WEBPACK_IMPORTED_MODULE_4__providers_service_service__["a" /* ServiceProvider */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["p" /* ModalController */]])
    ], HomePage);
    return HomePage;
}());
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_dom7_dist_dom7_modular__ = __webpack_require__(461);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ssr_window__ = __webpack_require__(457);
/**
 * Swiper 4.5.1
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ssr_window__ = __webpack_require__(457);
/**
 * Dom7 2.1.5
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_forms__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__home_home__ = __webpack_require__(459);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_service__ = __webpack_require__(128);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var LoginPage = /** @class */ (function () {
    function LoginPage(navCtrl, navParams, formbuilder, alertCtrl, service, loadingCtrl, modalCtrl) {
        this.navCtrl = navCtrl;
    ...
    LoginPage.prototype.numericOnly = function (event) {
        var patt = /^([0-9])$/;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (this.passloginform.invalid) {
                    ...
                    this.service.passwordlogin(this.passloginform.value).subscribe(function (res) {
                        if (res.status == 250) {
                            ...
                            localStorage.setItem('mobile_number', _this.passloginform.value.mobile_number);
                            localStorage.setItem('name', res.data[0].name);
                            localStorage.setItem('category_id', _this.passloginform.value.category);
                            localStorage.setItem('auth_ind', "1");
                            if (_this.passloginform.value.category == 1) {
                                localStorage.setItem('category', 'Believer');
                            }
                            else if (_this.passloginform.value.category == 2) {
                                localStorage.setItem('category', 'Student');
                            }
                            else if (_this.passloginform.value.category == 3) {
                                localStorage.setItem('category', 'Ministry');
                            }
                            else if (_this.passloginform.value.category == 4) {
                                localStorage.setItem('category', 'Pastor');
                            }
                            else if (_this.passloginform.value.category == 5) {
                                localStorage.setItem('category', 'Church');
                            }
                            else if (_this.passloginform.value.category == 6) {
                                localStorage.setItem('category', 'Independent Organization');
                            }
                            else if (_this.passloginform.value.category == 7) {
    ...
    LoginPage.prototype.gotoformspage = function () {
        this.navCtrl.setRoot('FormsPage');
    };
    LoginPage.prototype.togglePasswordMode = function () {
        this.password_type = this.password_type === 'text' ? 'password' : 'text';
    };
    LoginPage.prototype.gotoforgetpasswordpage = function () {
        var modal = this.modalCtrl.create('ForgotPasswordPage');
        modal.present();
    };
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-login',template:/*ion-inline-start:"C:\Users\rajes\StudioProjects\jbac_app\src\pages\login\login.html"*/'<ion-content padding class="pagecss">\n\n\n\n  <div class="form">\n\n    \n\n    <form [formGroup]="passloginform" >\n\n      <div class="header">\n\n        <img class="jabc" src="assets/icon/png/newlogo.png"><br><br>\n\n        JBAC యాప్ కి లాగిన్ అవ్వండి\n\n      </div>\n\n\n\n      <!-- <h1 style="text-align: center;">JBAC లాగిన్</h1> -->\n\n\n\n      <div class="inputs">\n\n        <select placeholder="మీ లాగిన్ క్యాటగిరి" class="input" formControlName="category">\n\n          <option value="" disabled selected>ఇక్కడ క్లిక్ చేసి ఎంచుకోండి</option>\n\n          <option value="1">విశ్వాసి</option>    \n\n          <option value="4">పాస్టర్</option>          \n\n          <option value="2">విద్యార్థి</option>\n\n          <option value="7">పాస్టర్ల అసోసియేషన్</option>\n\n          <option value="3">మినిస్ట్రీస్</option>\n\n          <option value="5">చర్చి</option>\n\n          <option value="6">క్రిస్టియన్ ఆర్గనైజెషన్ / కంపెనీ</option>\n\n         \n\n        </select>\n\n        \n\n        <input placeholder="మొబైల్ నంబర్ ఎంటర్ చేయండి" class="input" type="text" formControlName="mobile_number"\n\n          (keypress)="numericOnly($event)" maxlength="10" minlength="10">\n\n        \n\n        <input placeholder="పాస్వర్డ్ ఎంటర్ చేయండి" class="input" [type]="password_type" maxlength="16" minlength="4"\n\n          formControlName="password">\n\n\n\n        <div style="text-align: right;" class="field-icon" (click)="togglePasswordMode()">\n\n          <ion-icon name="eye"> </ion-icon> టైపు చేసిన పాస్వర్డ్ చూపించు\n\n        </div>\n\n        <button class="sigin-btn" (click)="passlogin()">సబ్మిట్</button>\n\n        <div style="text-align: center;" (click)="gotoforgetpasswordpage()">\n\n          <img src="assets/icon/svg/password.svg" style="width: 10%;margin-bottom: -3%;" ><b>రీసెట్ పాస్వర్డ్ / పాస్వర్డ్ మరిచిపోయాను</b> \n\n        </div>\n\n        <p class="signup-link" (click)="gotoformspage()">ఇంతకముందు రిజిస్టర్ కాకపోతే ? <a>రిజిస్టర్ </a></p>\n\n      </div>\n\n    </form>\n\n\n\n\n\n  </div>\n\n</ion-content>'/*ion-inline-end:"C:\Users\rajes\StudioProjects\jbac_app\src\pages\login\login.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["r" /* NavController */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["s" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1__angular_forms__["a" /* FormBuilder */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_4__providers_service_service__["a" /* ServiceProvider */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["o" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["p" /* ModalController */]])
    ], LoginPage);
    return LoginPage;
}());
