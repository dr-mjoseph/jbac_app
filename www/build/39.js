...
var AddmeetingsPage = /** @class */ (function () {
    ...
    AddmeetingsPage.prototype.useCurrentLocation = function () {
        ...
        var confirmAlert = this.alertctrl.create({
            ...
            message: 'మీ ప్రస్తుత ఖచ్చితమైన GPS లొకేషన్ మరియు అడ్రసును ఫారమ్‌లో నమోదు చేయడానికి అనుమతిస్తున్నారా?',
            buttons: [
                {
                    text: 'రద్దు (Cancel)',
                    role: 'cancel'
    ...
    AddmeetingsPage.prototype.executeGetCurrentLocation = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var reverseGeocode, applyLocation, handleFailure;
            return __generator(this, function (_a) {
                ...
                reverseGeocode = function (lat, lng) {
                    return __awaiter(_this, void 0, void 0, function () {
                        var nominatimUrl, resNom, dataNom, a, parts;
                ...
                applyLocation = function (lat, lng, place, source) {
                    ...
                    _this.locationSuccess = 'కరెంటు GPS లొకేషన్ విజయవంతముగా నమోదు చేయబడింది.';
